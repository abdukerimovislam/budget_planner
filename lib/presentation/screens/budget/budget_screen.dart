                ...
                delegate: SliverChildListDelegate([
                  ...
                  if (totalBudget > 0) ...[
                    ...
                    if (categoryBudgets.isEmpty)
                      Container(
                        padding: const EdgeInsets.all(24),
                        decoration: BoxDecoration(color: theme.colorScheme.surface.withValues(alpha: 0.8), borderRadius: BorderRadius.circular(24)),
                        child: Center(child: Text(l10n.categoryBudgetsEmpty, style: TextStyle(color: theme.colorScheme.onSurface.withValues(alpha: 0.5)))),
                      )
                    else
                      Container(
                        decoration: BoxDecoration(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  ...
                                                  style: TextStyle(
                                                      fontSize: 13,
                                                      fontWeight: FontWeight.w600,
                                                      color: isOverBudget ? CupertinoColors.systemRed : theme.colorScheme.onSurface.withValues(alpha: 0.5)
                                                  ),
                                                ),
                                              ],
                                            ),
